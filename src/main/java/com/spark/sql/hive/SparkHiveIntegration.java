...
public class SparkHiveIntegration {
	...
	public static void main(String[] args) {
		...
		spark.sql("drop table if  exists gfolynrf_standardization.om_account_dim_act");
		spark.sql("create external table if not exists gfolynrf_standardization.om_account_dim_actv (acti bigint , account_sk String) partitioned by (state string) stored as parquet");
